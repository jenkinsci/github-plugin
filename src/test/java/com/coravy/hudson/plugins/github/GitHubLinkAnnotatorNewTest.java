...
public class GitHubLinkAnnotatorNewTest {
    ...
    private static Object[] genActualAndExpected(String keyword) {
        ...
        return new Object[]{
            ...
            "An issue " + keyword + " #" + issueNumber + " link",
            // Output expected from the annotate method
            "An issue "
            + "<a href='" + GITHUB_URL + "issues/" + issueNumber + "/find'>"
            + keyword + " #" + issueNumber
            + "</a>"
            + " link"};
    }
